		...
		<div className="flex flex-col gap-8 items-center mt-14 px-10">
			...
			<div className="flex gap-8 w-full">
				<div className="w-[60%] overflow-hidden">
					<img className="object-cover h-full" src="/Apologia/table.jpg" alt="" />
				</div>
				<div className="w-[40%] overflow-hidden">
					<img className="object-cover h-full" src="/Apologia/avatar.jpg" alt="" />
				</div>
			</div>
			<p className="text-xl py-8 leading-normal">
			...
			<div className="flex gap-8 w-full">
				<div className="w-[40%] overflow-hidden">
					<img className="object-cover h-full" src="/Apologia/hoodie.jpg" alt="" />
				</div>
				<div className="w-[60%] overflow-hidden">
					<img className="object-cover h-full" src="/Apologia/guide.png" alt="" />
				</div>
			</div>
			<p className="text-xl py-8 leading-normal">
			...
			<div className="mt-10 w-full">
				<h1 className="text-5xl">Need help with a project?</h1>
